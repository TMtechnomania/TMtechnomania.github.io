...
import { getUserWallpaperList } from "./db.js";
...
async function injectWallpaperStats(settings) {
	...
	try {
		// DB init is handled internally by getUserWallpaperList
		const userWalls = await getUserWallpaperList(); // User uploaded (lightweight, no blobs)
