...
async function openTimerModal() {
    ...
    const body = document.createElement('div'); body.className='timer-body';
        ...
        const editBtn = document.createElement('button'); editBtn.className = 'btn-icon edit-btn'; editBtn.id = 'tm-edit';
    ...
    const startPauseBtn = document.createElement('button'); startPauseBtn.className='btn-icon'; startPauseBtn.id='tm-start-pause';
    attachIcon(startPauseBtn, 'assets/svgs-fontawesome/regular/circle-play.svg');
    const resetBtn = document.createElement('button'); resetBtn.className='btn-icon'; resetBtn.id='tm-reset';
    attachIcon(resetBtn, 'assets/svgs-fontawesome/solid/rotate-left.svg');
    const alertBtn = document.createElement('button'); alertBtn.className = 'btn-icon alert-btn'; alertBtn.id = 'tm-alert';
    ...
    const swStart = document.createElement('button'); swStart.className='btn-icon'; swStart.id='sw-start'; attachIcon(swStart, 'assets/svgs-fontawesome/regular/circle-play.svg');
    const swLap = document.createElement('button'); swLap.className='btn-icon'; swLap.id='sw-lap'; attachIcon(swLap, 'assets/svgs-fontawesome/regular/flag.svg');
    const swReset = document.createElement('button'); swReset.className='btn-icon'; swReset.id='sw-reset'; attachIcon(swReset, 'assets/svgs-fontawesome/solid/rotate-left.svg');
    ...
    const t1 = document.createElement('div'); t1.className='timer-tab active'; t1.id='tab-timer';
    attachIcon(t1, 'assets/svgs-fontawesome/regular/hourglass-half.svg');
    const t1Label = document.createElement('span'); t1Label.textContent='Timer'; t1.appendChild(t1Label);
    const t2 = document.createElement('div'); t2.className='timer-tab'; t2.id='tab-stopwatch';
    attachIcon(t2, 'assets/svgs-fontawesome/solid/stopwatch.svg');
    const t2Label = document.createElement('span'); t2Label.textContent='Stopwatch'; t2.appendChild(t2Label);
